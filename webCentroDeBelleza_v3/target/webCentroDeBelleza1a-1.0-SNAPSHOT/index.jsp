...
<html>
    ...
    <body>
        ...
        <div id="menu" class="container">
            <ul>
                ...
                <%--Verificacion de citas y parte Administrativa--%>
                <li class="login"><a href="#">Login</a>
                    <ul class="menu-vertical">
                        <li><a href="#" onClick="window.location.href='login.jsp'">Administración</a></li><br>
    ...
    <center>
        ...
        <%--Direccionamiento de registro--%>
            <center>
            <input type="button" value="Reserve su cita"   onClick="window.location.href='login2.jsp'"  class="botons" style="margin: 5px">
            </center>
