...
<!--Creacion de la tabla de citas-->                  
        ...
        <div class="container mt-4" id="titulo1">
            <h3><strong>Listado de Citas Turno Mañana:</strong></h3>
        </div>
        <tbody>
...
<!--Ejecuta el comando a la base de datos mediante lenguaje sql-->            
        <%
        try{
            PreparedStatement pst = conex.prepareStatement("select * from cita where HORA between '8:00' and '12:00' ORDER BY `cita`.`FECHA` ASC");
            ResultSet rs = pst.executeQuery();
        %>
...
<!--Creacion de la tabla de citas-->                  
        ...
        <div class="container mt-4" id="titulo1">
            <h3><strong>Listado de Citas Turno Tarde:</strong></h3>
        </div>
        <tbody>
...
<!--Ejecuta el comando a la base de datos mediante lenguaje sql-->            
        <%
        try{
            PreparedStatement pst = conex.prepareStatement("select * from cita where HORA between '12:01' and '18:00' ORDER BY `cita`.`FECHA` ASC");
            ResultSet rs = pst.executeQuery();
        %>
...
<!--Creacion de la tabla de citas-->                  
        ...
        <div class="container mt-4" id="titulo1">
            <h3><strong>Listado de Citas Turno Noche:</strong></h3>
        </div>
        <tbody>
...
<!--Ejecuta el comando a la base de datos mediante lenguaje sql-->            
        <%
        try{
            PreparedStatement pst = conex.prepareStatement("select * from cita where HORA between '18:01' and '22:00' ORDER BY `cita`.`FECHA` ASC");
            ResultSet rs = pst.executeQuery();
        %>
