...
<!--Conexion y obtension del DNI con la base de datos-->
            <tbody>
        <%
        try{
            int n1=0;
 ...
 <!--Se muestran la cantidad de citas por el DNI del cliente-->      
        <tr>
...
<!--Se añaden librerias para la estética-->
