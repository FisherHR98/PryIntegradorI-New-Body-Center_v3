...
<html>
    ...
    <body>
       ...
       <center><h4>INGRESE FECHA</h4></center>                      
        </b><input type="text" name="ndia"    id="dia"   class="controls" placeholder="Ingrese dia"      maxlength="5">
        <input type="text" name="nmonth"  id="month" class="controls" placeholder="Ingrese mes"      maxlength="5">
        <input type="text" name="nyear"   id="year"  class="controls" placeholder="Ingrese año"      maxlength="5">
