...
<!--Barra Superior-->
    ...
    <center>
        ...
        <div  class="form-register">
            ...
            <b>Horario:</b><br><i>Nota: Horario de Atencion de 8am - 10pm</i><br> 
            <input type="date" id="fecha" name="fecha" class="controls2">
            <input type="time" id="hora" name="hora" class="controls2" min="08:00" max="22:00">
            <br>
