...
<%--Envio y validacion a la base de datos--%>
    ...
    <center>
            ...
            <input type="button" value="Aceptar" onClick="window.location.href='cuentacli.jsp'" class="aceptar" style="margin: 5px">
    </center>
        <%
        }else{
        %>
        
<%--Caracteristicas de los paquetes de servicio--%>
...
<%--Ingreso de datos--%>
        ...
        <div  class="form-register">
            ...
            <center><input type="submit" value="Crear Cita" onclick="return validar()"                  class="botons" style="margin: 5px"><br>
                    <input type="button" value="Cancelar"   onClick="window.location.href='cuentacli.jsp'"  class="botons" style="margin: 5px"></center>
        </form>
        <%}//else%>
        </div>
